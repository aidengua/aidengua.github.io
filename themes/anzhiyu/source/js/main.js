// 第一次播放音乐
var dreamersaudio_musicFirst = false;
// 快捷键
var dreamersaudio_keyboard = null;
// 音乐播放状态
var dreamersaudio_musicPlaying = false;
var $bodyWrap = document.getElementById("body-wrap");
var dreamersaudio_intype = false;
var dreamersaudio_keyUpEvent_timeoutId = null;
var dreamersaudio_keyUpShiftDelayEvent_timeoutId = null;
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const timer = setInterval(() => {
      if (navMusicEl && navMusicEl.querySelector("#nav-music meting-js").aplayer) {
        ...
        navMusicEl.querySelector("#nav-music meting-js").aplayer.on("pause", function () {
          ...
          dreamersaudio_musicPlaying = false;
        ...
        navMusicEl.querySelector("#nav-music meting-js").aplayer.on("play", function () {
          ...
          dreamersaudio_musicPlaying = true;
  ...
  function setInputFocusListener() {
    ...
    filteredinputs.forEach(input => {
      input.addEventListener("focus", () => {
        dreamersaudio_intype = true;
      });

      input.addEventListener("blur", () => {
        dreamersaudio_intype = false;
      });
    });
  }
  ...
  function executeShortcutKeyFunction() {
    // 是否开启快捷键
    dreamersaudio_keyboard = localStorage.getItem("keyboardToggle") ? localStorage.getItem("keyboardToggle") : false;
    ...
    function keyDownEvent(event) {
      ...
      const isKeyboardEnabled = dreamersaudio_keyboard;
      const isInInputField = dreamersaudio_intype;
      ...
      if (isKeyboardEnabled && isShiftKeyPressed && !isInInputField) {
        dreamersaudio_keyUpShiftDelayEvent_timeoutId = setTimeout(() => {
          switch (event.keyCode) {
            case 16:
              dreamersaudio_keyUpEvent_timeoutId = setTimeout(() => {
    ...
    function keyUpEvent(event) {
      dreamersaudio_keyUpEvent_timeoutId && clearTimeout(dreamersaudio_keyUpEvent_timeoutId);
      dreamersaudio_keyUpShiftDelayEvent_timeoutId && clearTimeout(dreamersaudio_keyUpShiftDelayEvent_timeoutId);
      if (event.keyCode === 16) {
